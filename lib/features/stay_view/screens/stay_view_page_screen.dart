...
class _StayViewPageScreenState extends State<StayViewPageScreen> {
        ...
        child: Row(
          children: [
            ...
            ...List.generate(datas.length, (index) {
              final avail = datas[index]['availability'].toInt();
  ...
  void _handleGuestTap(
    ...
    final guestItem = GuestItem(
      ...
      nights: nights.toInt(),
      roomNumber: roomNumber,
      roomType: section['roomTypeName'],
      reservationType: 'Unknown', // Not in data, default
      avgDailyRate: 0.0, // Not in data
      totalAmount: 0.0, // Not in data
      totalCredits: 0.0, // Not in data
      balanceAmount: 0.0, // Not in data
      adults: 1, // Default
      children: 0, // Default
      phone: '', // Not in data
      mobile: '', // Not in data
      email: '', // Not in data
      idType: '', // Not in data
      idNumber: '', // Not in data
      expiryDate: '', // Not in data
      dob: '', // Not in data
      nationality: '', // Not in data
      arrivalBy: '', // Not in data
      departureBy: '', // Not in data
      businessSource: '', // Not in data
      company: '', // Not in data
      travelAgent: '', // Not in data
      childAge: null,
      roomCharges: 0.0, // Not in data
      discount: 0.0,
      tax: 0.0,
      adjustment: 0.0,
      netAmount: 0.0,
      folioId: checkIn['bookingRoomId'].toString(),
      remarks: '', // Not in data
      folioCharges: [],
      bookingRoomId: checkIn['bookingRoomId'].toString(),
      resId: '',
    );
