                      ...
                      Column(
                        ...
                        children: [
                          ...
                          MultiSelectDialogField<HotelItem>(
                            ...
                            buttonText: Text(
                              _selectedHotels.isEmpty ? "Select" : "View",
                              style: TextStyle(
                                color: AppColors.onPrimary,
                                fontSize: 14,
                              ),
                        ...
                        if (!_managerReportVm.isShowHotelDropdown.value) {
                          ...
                          return Expanded(
                            child: DropdownButton<int>(
                              ...
                              value: _managerReportVm.selectedHotel.value == -1
                                  ? null
                                  : _managerReportVm.selectedHotel.value,
                              dropdownColor: Colors.white,
                              underline: Container(),
                              iconEnabledColor: AppColors.onPrimary,
                              selectedItemBuilder: (BuildContext context) {
                                return _managerReportVm.receivedHotels
                                    .map<Widget>((hotel) {
                                      return Text(
                                        hotel["hotelName"],
                                        style: TextStyle(
                              ...
                              items: _managerReportVm.receivedHotels.map((
                                hotel,
                              ) {
                              ...
                              onChanged: (value) {
                                _managerReportVm.selectedHotel.value = value!;
                                _managerReportVm.loadTablesAccordingToHotel();
                              },
                            ),
                          );
                        }
                            ...
                            rows: [
                              ...
                              DataRow(
                                cells: [
                                  ...
                                  _rightCell(
                                    formatCurrency(
                                      _managerReportVm.payoutDataTotals["ptd"],
                                    ).toString(),
                                  ),
                                  _rightCell(
                                    formatCurrency(
                                      _managerReportVm.payoutDataTotals["ytd"],
                                    ).toString(),
                                  ),
                                ],
                              ),
                            ...
                            rows: [
                              ...
                              DataRow(
                                cells: [
                                  ...
                                  _rightCell(
                                    formatCurrency(
                                      _managerReportVm.paymentDataTotals["ptd"],
                                    ).toString(),
                                  ),
                                  _rightCell(
                                    formatCurrency(
                                      _managerReportVm.paymentDataTotals["ytd"],
                                    ).toString(),
                                  ),
                                ],
                              ),
