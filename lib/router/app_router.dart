...
//     GoRoute(path: AppRoutes.cancelReservation, builder: (context,state) =>  CancelReservation(reservationData: state.extra as Map<String, dynamic>) ),
...
//     GoRoute(path: AppRoutes.blockRoomDetails,builder: (context, state) {final selectedRooms = state.extra as List<RoomResponse>;return BlockRoomDetailsScreen(selectedRooms: selectedRooms);},),
