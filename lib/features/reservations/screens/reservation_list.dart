...
class _ReservationListState extends State<ReservationList> {
    ...
    fullData.forEach((tab, items) {
      filteredMap[tab] = items.where((item) {
        ...
        DateTime itemDate = dateFilterType == 'reserved'
            ? _parseMockDate(item.reservedDate ?? item.startDate)  // Fallback to startDate if reservedDate not set
  ...
  DateTime _parseMockDate(String dateStr) {
    // Mock parser assuming 'MMM dd' format, append current year
