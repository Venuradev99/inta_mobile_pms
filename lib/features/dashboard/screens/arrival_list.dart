...
class _ArrivalListState extends State<ArrivalList> with TickerProviderStateMixin {
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [
                _buildArrivalTab('today'),
                _buildArrivalTab('tomorrow'),
                _buildArrivalTab('week'),
              ],
            ),
          ),
        ],
  ...
  Widget _buildArrivalTab(String period) {
    final List<ArrivalItem> arrivals = _getArrivalsForPeriod(period);
    if (arrivals.isEmpty) {
  ...
  Widget _buildArrivalCard(ArrivalItem arrival) {
    return GestureDetector(
      onTap: () => _showArrivalActionsBottomSheet(context, arrival),
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: AppColors.surface,
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Res: ${arrival.resId} | Folio: ${arrival.folioId}',
            ...
            Row(
              children: [
                Text(
                  'Total: \$${arrival.totalAmount.toStringAsFixed(2)}',
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w500,
                  ),
                ),
                const Spacer(),
                Text(
                  'Balance: \$${arrival.balanceAmount.toStringAsFixed(2)}',
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                    color: Colors.red,
                    fontWeight: FontWeight.w500,
                  ),
          ...
          child: Column(
            ...
            children: [
              ...
              _buildStatusItem(
                context,
                'Confirm Reservation',
                'Reservations that need confirmation',
                Colors.orange[700]!,
...
void _showArrivalActionsBottomSheet(BuildContext context, ArrivalItem arrival) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildActionItem(Icons.meeting_room, 'Assign Rooms'),
                      _buildActionItem(Icons.edit_calendar, 'Amend Stay'),
                      _buildActionItem(Icons.swap_horiz, 'Change Reservation Type'),
                      _buildActionItem(Icons.cancel, 'Cancel Reservation'),
                      _buildActionItem(Icons.block, 'Void Reservation'),
  ...
  List<ArrivalItem> _getArrivalsForPeriod(String period) {
